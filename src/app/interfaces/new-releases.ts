// To parse this data:
//
//   import { Convert, SpotiResponse } from "./file";
//
//   const spotiResponse = Convert.toSpotiResponse(json);
//
...
export class Convert {
    public static toSpotiResponse(json: string): SpotiResponse {
        return cast(JSON.parse(json), r("SpotiResponse"));
    }

    public static spotiResponseToJson(value: SpotiResponse): string {
        return JSON.stringify(uncast(value, r("SpotiResponse")), null, 2);
    }
}
